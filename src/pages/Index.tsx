        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-sm text-gray-600">
              <span className="font-semibold">Add-ons:</span> Priority Support
              (€49/month), Multi-Site Basic up to 3 locations (€99/month),
              Custom Course Upload, Storage+ 50GB (€19/month), Storage+ 200GB
              (€59/month), Storage Unlimited (€149/month)
            </p>
          </div>
        </div>
      </section>
